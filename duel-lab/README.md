...
現在は[初動の自動入力](docs/OPENING_AUTOPLAY.md)へ接続済み。無ドロー79テンプレートを読み、実際の5枚手札で候補を効果処理してから、MDPro3の合法な選択肢へ入力する。2枚組333種類の検証は[複数枚初動](docs/MULTI_OPENINGS.md)、追加した具体的展開は[multi-malice](docs/multi-malice.md)・[multi-cyberse](docs/multi-cyberse.md)。
