        ...
        const { saveGalleryToCache, loadGalleryFromCache, isGalleryRemoteNewer, updateGalleryMetadata, trackDeletedId } = createCacheSystem({
            api,
            ...
            switchListType: (...args) => switchListType(...args)
        });
        ...
        const { getCardUsageInDecks, loadDecks, getCurrentDeck } = createDeckSystem({
            api,
            getCurrentUser: () => currentUser,
            getDecks: () => decks,
            setDecks: (value) => { decks = value; },
            ...
            saveGalleryToCache: (...args) => saveGalleryToCache(...args),
            updateGalleryMetadata: (...args) => updateGalleryMetadata(...args),
            renderCards: (...args) => renderCards(...args),
            applyFilters: (...args) => applyFilters(...args),
            updateStats: (...args) => updateStats(...args),
            escapeHtml: (...args) => escapeHtml(...args),
            decodeHtmlEntities: (...args) => decodeHtmlEntities(...args),
            getCardImageUrl: (...args) => getCardImageUrl(...args),
        ...
        const { loadPublicProfile, initializeCommunity } = createCommunitySystem({
            ...
            escapeHtml: (...args) => escapeHtml(...args),
            decodeHtmlEntities: (...args) => decodeHtmlEntities(...args),
            switchToPlaymat: (...args) => switchToPlaymat(...args),
            applyPlaymatFilter: (...args) => applyPlaymatFilter(...args)
        });
